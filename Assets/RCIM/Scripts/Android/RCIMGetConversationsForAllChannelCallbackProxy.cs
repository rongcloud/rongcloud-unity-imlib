...
{
    public class RCIMGetConversationsForAllChannelCallbackProxy : AndroidJavaProxy
    {
        RCIMGetConversationsForAllChannelListener listener;
    
        public RCIMGetConversationsForAllChannelCallbackProxy(RCIMGetConversationsForAllChannelListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWGetConversationsForAllChannelCallback")
        {
