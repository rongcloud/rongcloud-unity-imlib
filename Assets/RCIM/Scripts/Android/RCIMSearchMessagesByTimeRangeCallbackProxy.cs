...
{
    public class RCIMSearchMessagesByTimeRangeCallbackProxy : AndroidJavaProxy
    {
        RCIMSearchMessagesByTimeRangeListener listener;
    
        public RCIMSearchMessagesByTimeRangeCallbackProxy(RCIMSearchMessagesByTimeRangeListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWSearchMessagesByTimeRangeCallback")
        {
