...
{
    public class RCIMSearchMessagesByUserIdCallbackProxy : AndroidJavaProxy
    {
        RCIMSearchMessagesByUserIdListener listener;
    
        public RCIMSearchMessagesByUserIdCallbackProxy(RCIMSearchMessagesByUserIdListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWSearchMessagesByUserIdCallback")
        {
