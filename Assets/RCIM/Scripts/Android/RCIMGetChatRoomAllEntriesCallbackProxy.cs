...
{
    public class RCIMGetChatRoomAllEntriesCallbackProxy : AndroidJavaProxy
    {
        RCIMGetChatRoomAllEntriesListener listener;
    
        public RCIMGetChatRoomAllEntriesCallbackProxy(RCIMGetChatRoomAllEntriesListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWGetChatRoomAllEntriesCallback")
        {
