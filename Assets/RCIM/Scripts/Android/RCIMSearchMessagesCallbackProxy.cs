...
{
    public class RCIMSearchMessagesCallbackProxy : AndroidJavaProxy
    {
        RCIMSearchMessagesListener listener;
    
        public RCIMSearchMessagesCallbackProxy(RCIMSearchMessagesListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWSearchMessagesCallback")
        {
