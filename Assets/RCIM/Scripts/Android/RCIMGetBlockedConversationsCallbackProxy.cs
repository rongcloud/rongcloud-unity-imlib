...
{
    public class RCIMGetBlockedConversationsCallbackProxy : AndroidJavaProxy
    {
        RCIMGetBlockedConversationsListener listener;
    
        public RCIMGetBlockedConversationsCallbackProxy(RCIMGetBlockedConversationsListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWGetBlockedConversationsCallback")
        {
