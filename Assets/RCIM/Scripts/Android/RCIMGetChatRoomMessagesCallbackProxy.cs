...
{
    public class RCIMGetChatRoomMessagesCallbackProxy : AndroidJavaProxy
    {
        RCIMGetChatRoomMessagesListener listener;
    
        public RCIMGetChatRoomMessagesCallbackProxy(RCIMGetChatRoomMessagesListener listener)
            : base("cn.rongcloud.im.wrapper.callback.IRCIMIWGetChatRoomMessagesCallback")
        {
