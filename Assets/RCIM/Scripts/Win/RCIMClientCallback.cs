...
{
    public partial class RCIMClientWin
    {
        #region callback
        ...
        private static void on_im_connect_status(IntPtr context, RCErrorCode code)
        {
            if (RCIMClient.Instance is RCIMClientWin imClient)
            {
                imClient.OnIMConnectStatus?.Invoke(code, "");
                imClient.OnIMConnectStatus = null;
            }            
        }
